-------------------------------------------------------------------------------
-- xmonad.hs
-- Last update: 2021-12-22 18:01:45 (CET)
-------------------------------------------------------------------------------
...
myKeys =
  [
    ...
    ((mod1Mask .|. shiftMask,    xK_q      ), spawn "$HOME/.config/xmonad/exit.sh message"),
    ...
    ((0, xF86XK_ModeLock                   ), spawn "$HOME/.config/xmonad/exit.sh lock"),
