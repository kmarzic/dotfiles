...
function __get_latest()
{
    ...
    ## ------------------------------------------------------------------------
    echo ""
    echo "https://github.com/ryanoasis/nerd-fonts/tree/master/patched-fonts/DejaVuSansMono/Bold-Italic"
    ...
    ## ------------------------------------------------------------------------
    echo ""
    echo "https://github.com/ryanoasis/nerd-fonts/tree/master/patched-fonts/SourceCodePro"
    cd ~/.local/share/fonts && curl -fLo "SauceCodeProNerdFont-Regular.ttf"               https://github.com/ryanoasis/nerd-fonts/blob/master/patched-fonts/SourceCodePro/SauceCodeProNerdFont-Regular.ttf?raw=true
    cd ~/.local/share/fonts && curl -fLo "SauceCodeProNerdFontMono-Regular.ttf"           https://github.com/ryanoasis/nerd-fonts/blob/master/patched-fonts/SourceCodePro/SauceCodeProNerdFontMono-Regular.ttf?raw=true
    cd ~/.local/share/fonts && curl -fLo "SauceCodeProNerdFontPropo-Regular.ttf"          https://github.com/ryanoasis/nerd-fonts/blob/master/patched-fonts/SourceCodePro/SauceCodeProNerdFontPropo-Regular.ttf?raw=true
    cd ~/.local/share/fonts && curl -fLo "SauceCodeProNerdFont-Bold.ttf"                  https://github.com/ryanoasis/nerd-fonts/blob/master/patched-fonts/SourceCodePro/SauceCodeProNerdFont-Bold.ttf?raw=true
    cd ~/.local/share/fonts && curl -fLo "SauceCodeProNerdFontMono-Bold.ttf"              https://github.com/ryanoasis/nerd-fonts/blob/master/patched-fonts/SourceCodePro/SauceCodeProNerdFontMono-Bold.ttf?raw=true
    cd ~/.local/share/fonts && curl -fLo "SauceCodeProNerdFontPropo-Bold.ttf"             https://github.com/ryanoasis/nerd-fonts/blob/master/patched-fonts/SourceCodePro/SauceCodeProNerdFontPropo-Bold.ttf?raw=true
    cd ~/.local/share/fonts && curl -fLo "SauceCodeProNerdFont-Italic.ttf"                https://github.com/ryanoasis/nerd-fonts/blob/master/patched-fonts/SourceCodePro/SauceCodeProNerdFont-Italic.ttf?raw=true
    cd ~/.local/share/fonts && curl -fLo "SauceCodeProNerdFontMono-Italic.ttf"            https://github.com/ryanoasis/nerd-fonts/blob/master/patched-fonts/SourceCodePro/SauceCodeProNerdFontMono-Italic.ttf?raw=true
    cd ~/.local/share/fonts && curl -fLo "SauceCodeProNerdFontPropo-Italic.ttf"           https://github.com/ryanoasis/nerd-fonts/blob/master/patched-fonts/SourceCodePro/SauceCodeProNerdFontPropo-Italic.ttf?raw=true
...
function __get_release()
{
    ...
    # #### https://github.com/ryanoasis/nerd-fonts/ - 3.3.0
    # curl -L https://github.com/ryanoasis/nerd-fonts/releases/download/v3.3.0/DejaVuSansMono.zip -o ~/Downloads/DejaVuSansMono_v3.3.0.zip
    # curl -L https://github.com/ryanoasis/nerd-fonts/releases/download/v3.3.0/Inconsolata.zip -o ~/Downloads/Inconsolata_v3.3.0.zip
    # curl -L https://github.com/ryanoasis/nerd-fonts/releases/download/v3.3.0/UbuntuMono.zip -o ~/Downloads/UbuntuMono_v3.3.0.zip
    # curl -L https://github.com/ryanoasis/nerd-fonts/releases/download/v3.3.0/SourceCodePro.zip -o ~/Downloads/SourceCodePro_v3.3.0.zip
    # curl -L https://github.com/ryanoasis/nerd-fonts/releases/download/v3.3.0/Hack.zip -o ~/Downloads/Hack_v3.3.0.zip
    # curl -L https://github.com/ryanoasis/nerd-fonts/releases/download/v3.3.0/BitstreamVeraSansMono.zip -o ~/Downloads/BitstreamVeraSansMono_v3.3.0.zip
