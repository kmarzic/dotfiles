...
function __rsync()
{
    ...
    __printf ""
    __printf "# rsync -avzhHp --delete /mnt/ntadmin/Servers/mail.*.xlsx ~/data/projects/ETK/ICT/docs/Servers" success
    rsync -avzhHp --delete /mnt/ntadmin/Servers/mail.*.xlsx ~/data/projects/ETK/ICT/docs/Servers
