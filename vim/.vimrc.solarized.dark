...
"" Pathogen: Vim package manager (2.4)
...
"" Command-t: Pattern based file opener (4.0)
...
"" cd ~/.vim/bundle/YouCompleteMe; git remote update
...
"
map ,lt1 :TlistToggle<CR>
vmap ,lt1 <esc>:TlistToggle<CR>
imap ,lt1 <esc>:TlistToggle<CR>
...
augroup filetype
    ...
    autocmd BufNewFile,BufRead c,cpp,java,slang,perl,python,html,xml,css,sh,php,asp,go set filetype=srcfile
augroup END
...
autocmd FileType c,cpp,java,slang,perl,python,html,xml,css,sh,php,asp,go set expandtab
...
autocmd FileType c,cpp,java,slang,perl,python,html,xml,css,sh,php,asp,go set shiftwidth=4
autocmd FileType make set shiftwidth=4

"" Unset TextWitdh
autocmd FileType mail set textwidth=78
autocmd FileType human set textwidth=78
autocmd FileType tex set textwidth=78
autocmd FileType haskell set textwidth=0
autocmd FileType c,cpp,java,slang,perl,python,html,xml,css,sh,php,asp,go set textwidth=0
...
autocmd FileType c,cpp,java,slang,perl,python,html,xml,css,sh,php,asp,go set number
...
autocmd FileType perl,python,css,sh,php,asp,make set autoindent
